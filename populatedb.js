...
debug('This script populates some test books, authors, genres and bookinstances to your database. Specified database as argument - e.g.: populatedb mongodb+srv://cooluser:coolpassword@cluster0-mbdj7.mongodb.net/local_library?retryWrites=true');
...
function bookInstanceCreate(book, imprint, due_back, status, cb) {
  ...
  bookinstance.save(function (err) {
    ...
    debug('New BookInstance: ' + bookinstance);
...
function(err, results) {
    if (err) {
        ...
        debug('BOOKInstances: '+bookinstances);
